...
listening to music, school activities, working on personal projects and working
for companies, I use Linux. For playing games I use Windows. As such I do not
have Windows on my laptop.

I'm not forced to use Linux, neither by my current job or school. I use Linux
...
to provide a free and simple to use OS, while other may want to provide a
...
The other points are a bit more easy to understand but it boils down to how
...
desktop OS and are true for every distributions. Linux makes it very easy to
...
is broken in small components, making it so I can always replace parts of the
OS with alternatives, if I'm either disatisfied with the way something works or
...
extra steps if you want non-free stuffs, such as installing Chrome, Steam,
...
for performances, hardware support, security and programming.
...
release, which happen every 6 months. Just like every other distributions, if
...
distribution for almost every use cases, but I need to talk about other stuffs
...
community copy of Red Hat Entreprise Linux, which is based off Fedora but with a
...
have frequent updates for a desktop usage so I might switch it back to Fedora
relatively soon.
...
For approximatively 4 years, I've been using either i3 or sway, which are
...
different and so a lot of stuffs looked out of place. While some apps like my
...
Just like with code editors and distros, there is a sort of war ungoing between
the users of each desktops, and GNOME has a reputation of being slow and
...
I do not use many behavior changing extensions, most of what I have installed
...
i3 did not really have this but instead I made an habit of putting specific apps
...
application in your bar, or open it if there is no currently open windows of
...
As you probably know, I consume a lot of Japanese medias, namely anime, music,
...
country, but mainly because I'm upset about the services fragmentation and
catalogue. I do not want to have to subscribe to 10 different services to watch
the anime series I want to watch.

Piracy is nothing to brag about and I tend to make a point of avoiding to talk
...
convenient because they weight way less, it's usually between 300 or 400MB for a
...
through the file as it is being downloaded. This makes it no different to what
...
Finally, as far as musics go, I have a collection of albums that I have either
...
home, which is directly plugged to fiber Internet, and allow me to stream it
...
its access to Internet. This way the Chinese government won't be able to spy on
...
work than making sure their application works on every distributions.

[Flathub][flathub] is the main store front for Flatpak applications, I already
showed how it can be integrated in the GNOME Software app earlier, it provides
...
I use them everyday and got so used to them, I kind of forget what really
sticks out and is worth recommending. First of, here's a screenshot of my
application drawer.
...
I use Firefox as my Internet browser and I like what Mozilla creates and do. I
however also have ungoogled-chromium installed as I like one of the features
Chromium has, which is being able to run website in a dedicated app-like view,
...
I use the GNOME's default files explorer, Nautilus, even though I do most of my
...
I use GIMP to edit screenshot or make simple collages. I'm envious of some
...
GNOME's default option which is called Boxes, which dumbs down the process of
...
my files, Firefox or Discord, I use the keyboard shortcuts I mentionned (Windows
...
such as adding texts or underlining and highlighting things. It also have a very
wide range of post-capture options, such as uploading to an hosting service,
...
envisionned, and I don't think I will have the energy to update it over time, so
...
If you have any question about anything I talked about here, don't hesitate to
